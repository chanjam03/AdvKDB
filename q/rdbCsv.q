...
//  RDB CSV q script
//
//  q rdbCSv.q -p <PORT_RDB_CSV> -tp <PORT_TICK> -hdbp <PORT_HDB> -libCommon <LIB_COMMON> -libR <LIB_R> -dirHDB <DIR_HDB>
//
//  i.e. q rdb2.q -p 5032 -tp 5010 -hdbp 5012 -libCommon AdvKDB/q/common/common.q -libR AdvKDB/q/tick/r.q -dirHome AdvKDB/hdb
//
//  Parameters:
//      - [p]: port to start rdbCsv process on as determined by config file
